...
kaos::input::error start_kaos_input(kaos::input::input_receiver_1 const& p_event_receiver, kaos::input::version_info const frontend_version)
{
...
kaos::input::version_info kaos_input_API_version()
{
...
kaos::input::version_info kaos_input_backend_version()
{
	return kaos::input::version_info{.number = kaos::input::backend::version().number };
}
